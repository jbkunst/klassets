...
df <- sim_groups_for_clusters(n = 500, groups = 3)
...
```{r, echo=FALSE}
try(knitr::include_graphics(here::here("man/figures/animation_kmeans_iterations.gif")))
try(knitr::include_graphics(here::here("reference/figures/animation_kmeans_iterations.gif")), silent = TRUE)
```
